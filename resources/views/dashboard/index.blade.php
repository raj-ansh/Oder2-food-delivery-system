        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
                <div class="inner">
                    ...
                    <p>{{trans('lang.regional_managers')}} <span style="font-size: 11px">({{trans('lang.dashboard_after taxes')}})</span></p>
                </div>
                <div class="icon">
                    <i class="fa fa-money"></i>
                </div>
