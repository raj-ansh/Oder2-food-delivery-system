...
<!-- Name Field -->
<input type="hidden" name="user_id" value="$lastId">
<div class="form-group row">
  {!! Form::label('name', trans("Supply Head"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::select('chain_id', $sh, null, ['class' => 'select2 form-control']) !!}
