...
<!-- Admin Commission -->
<div class="form-group row ">
  {!! Form::label('admin_commission', trans("lang.services_admin_commission"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::text('admin_commission', null, ['class' => 'form-control','placeholder'=>
     trans("lang.services_admin_commission_placeholder")  ]) !!}
    <div class="form-text text-muted">{{ trans("lang.services_agent_commission_help") }}</div>
  </div>
</div>
