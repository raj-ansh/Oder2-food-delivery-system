...
<div class="form-group row">
  {!! Form::label('name', trans("BDM"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::select('chain_id', $bde, null, ['class' => 'select2 form-control']) !!}
...
<div class="form-group col-12 text-right">
  ...
  <a href="{!! route('seniorbde.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
