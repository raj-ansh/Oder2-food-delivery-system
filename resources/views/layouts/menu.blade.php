...
@can('marketing.dashboard')
<li class="nav-item">
    <a class="nav-link {{ Request::is('dashboard*') ? 'active' : '' }}" href="{!! url('dashboard/marketing') !!}">@if($icons)
        <i class="nav-icon fa fa-dashboard"></i>@endif
...
<li class="nav-item has-treeview {{ Request::is('insurance*') || Request::is('services*') ? 'menu-open' : '' }}">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Request::is('advertisement*') ? 'active' : '' }}" href="{!! route('advertisement.index') !!}">@if($icons)
                <i class="nav-icon fa fa-folder"></i>@endif<p>{{trans('lang.services_plural')}}</p></a>
        </li>
        @endcan
    </ul>
...
@can('marketing.show')
<li class="nav-item has-treeview {{ Request::is('country*') || Request::is('faqs*') ? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('country*') || Request::is('country*') ? 'active' : '' }}"> @if($icons)
        <i class="nav-icon fa fa-support"></i>@endif
        <p>Marketing <i class="right fa fa-angle-left"></i>
        </p>
    </a>
    <ul class="nav nav-treeview">
        @can('country_head.show')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('country*') ? 'active' : '' }}" href="{!! route('country.index') !!}">@if($icons)
                <i class="nav-icon fa fa-folder"></i>@endif<p>Country Head</p></a>
        </li>
        @endcan
        @can('businesshead.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('country*') ? 'active' : '' }}" href="{!! route('businesshead.index') !!}">@if($icons)
                <i class="nav-icon fa fa-folder"></i>@endif<p>Business Head</p></a>
        </li>
        @endcan
        @can('regional_manager.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('regional_manager*') ? 'active' : '' }}" href="{!! route('regional_manager.index') !!}">@if($icons)
                <i class="nav-icon fa fa-question-circle"></i>@endif
                <p>Regional Manager</p></a>
        </li>
        @endcan
        @can('supplyhead.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('supplyhead*') ? 'active' : '' }}" href="{!! route('supplyhead.index') !!}">@if($icons)
                <i class="nav-icon fa fa-question-circle"></i>@endif
                <p>Supply Head</p></a>
        </li>
        @endcan
        @can('servicebdm.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('servicebdm*') ? 'active' : '' }}" href="{!! route('servicebdm.index') !!}">@if($icons)
                <i class="nav-icon fa fa-question-circle"></i>@endif
                <p>Service B.D.M</p></a>
        </li>
        @endcan
        @can('bdm.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('bdm*') ? 'active' : '' }}" href="{!! route('bdm.index') !!}">@if($icons)
                <i class="nav-icon fa fa-question-circle"></i>@endif
                <p>B.D.M</p></a>
        </li>
        @endcan
        @can('seniorbde.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('seniorbde*') ? 'active' : '' }}" href="{!! route('seniorbde.index') !!}">@if($icons)
                <i class="nav-icon fa fa-question-circle"></i>@endif
                <p>Senior BDE</p></a>
        </li>
        @endcan
        @can('bde.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('bde*') ? 'active' : '' }}" href="{!! route('bde.index') !!}">@if($icons)
                <i class="nav-icon fa fa-question-circle"></i>@endif
                <p>BDE</p></a>
        </li>
        @endcan
