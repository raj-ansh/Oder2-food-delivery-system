...
<div class="form-group row">
  {!! Form::label('chain_id', trans("Senior BDE"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::select('chain_id', $seniorbde, null, ['class' => 'select2 form-control']) !!}
...
<div class="form-group row ">
  ...
  <div class="col-9">
    {!! Form::select('state',['odisha','Kerala','Gujarat'], null,  ['class' => 'form-control']) !!}
    <div class="form-text text-muted">
      {{ trans("lang.category_name_help") }}
    </div>
  </div>
...
<div class="form-group col-12 text-right">
  ...
  <a href="{!! route('bde.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
