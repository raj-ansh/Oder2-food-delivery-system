...
<div class="form-group row">
  {!! Form::label('name', trans("Business Head"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
    {!! Form::select('chain_id', $businesshead, null, ['class' => 'select2 form-control']) !!}
...
<div class="form-group row ">
  ...
  <div class="col-9">
    {!! Form::text('dob', null,  ['class' =>'date form-control']) !!}
    <div class="form-text text-muted">
      {{ trans("lang.category_name_help") }}
    </div>
  </div>
