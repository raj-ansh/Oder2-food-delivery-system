...
class RestaurantAPIController extends Controller
{
    ...
    public function restaurantbyagentid(Request $request)
    {
        $input = $request->all();
        $restaurant = $this->restaurantRepository->customresturant($input['agent_id']);
        return $this->sendResponse($restaurant->toArray(), __('lang.retrieved_successfully', ['operator' => __('lang.restaurant')]));
    }
