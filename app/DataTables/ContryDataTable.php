...
class ContryDataTable extends DataTable
{
    /**
    ...
    protected function getColumns()
    {
        ...
        $hasCustomField = in_array(Contry::class, setting('custom_field_models', []));
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', Contry::class)->where('in_table', '=', true)->get();
     ...
     */
    public function query(Contry $model)
    {
